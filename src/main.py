...
# Function to create and compile shaders from source files
...
class App:
    ...
    # Initializes game objects, shaders, and other resources
    def _create_assets(self):
        ...
        orbit_params = [(None, 0, 0), ([0, 0, -8], 2, 0.5), (None, 0.5, 3)]
        ...
        self.shader = create_shader("shaders/simple.vert", "shaders/simple.frag")

    # Sets projection matrix and other one-time OpenGL settings
    def _set_onetime_uniforms(self):
        glUseProgram(self.shader)
        glUniform1i(glGetUniformLocation(self.shader, "imageTexture"), 0)
        projection_transform = pyrr.matrix44.create_perspective_projection(fovy=45, aspect=1280/720, near=0.1, far=50, dtype=np.float32)
